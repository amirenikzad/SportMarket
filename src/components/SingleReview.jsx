  ...
  return (
    <article className="mb-10">
      ...
      <div className="flex items-center mb-1 space-x-1 rtl:space-x-reverse">
        ...
        <h3 className="ms-2 text-sm font-semibold text-stone-950">
          {reviewObj.reviewTitle}
        </h3>
      </div>
      <footer className="mb-5 text-sm text-stone-950">
        <p>
          Reviewed in the {reviewObj.location + " "}
          <time>{reviewObj.date}</time>
        </p>
      </footer>
      <p className="mb-2 text-stone-950">{reviewObj.reviewText}</p>
    </article>
  );
};
