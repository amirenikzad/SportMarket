        ...
        {orders?.length === 0 ? (
          ...
          orders.map((order) => {
            return (
              <div
                key={nanoid()}
                className="collapse collapse-plus bg-red-700 mb-2"
              >
                <input type="radio" name="my-accordion-3" />
                <div className="collapse-title text-xl font-medium text-stone-950">
                    ...
                    <table className="table max-sm:table-xs table-pin-rows table-pin-cols">
                      ...
                      <tbody>
                        {order.cartItems.map((product, counter) => (
                          <tr className="text-stone-950" key={nanoid()}>
                            <th>{counter + 1}</th>
                        ...
                        <tr>
                          <td colSpan="5" className="text-center">
                            <h4 className="text-md text-stone-950">
                        ...
                        <tr>
                          <td colSpan="5" className="text-center">
                            <h3 className="text-md text-stone-950">
                              Shipping: $50
                            </h3>
                          </td>
                        </tr>
