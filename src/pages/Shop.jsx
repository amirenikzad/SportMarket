...
const Shop = () => {
  ...
  return (
    <>
      <SectionTitle title="فروشگاه" path="" />
      <div className="max-w-7xl mx-auto mt-5">
        <Filters />
        {productLoaderData.productsData.length === 0 && <h2 className="text-stone-950 text-center text-4xl my-10">هیچ محصولی برای این فیلتر پیدا نشد</h2>}
